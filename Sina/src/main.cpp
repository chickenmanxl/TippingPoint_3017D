...
void autonomous(void) {
  ...
  ClawB.set(true);  //grabs the tower
  wait(.1, seconds);
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    while(Controller1.ButtonR2.pressing()){ //Lifts up the front tower lift
      TowerFLift.spin(fwd, 70, pct);
    }

    while(Controller1.ButtonR1.pressing()){ //Lowers the front tower lift
      TowerFLift.spin(reverse, 70, pct);
    }

    while(Controller1.ButtonL2.pressing()){ //Lifts up the back tower lift
      TowerBLift.spin(fwd, 70, pct);
    }

    while(Controller1.ButtonL1.pressing()){ //Lowers the back tower lift
      TowerBLift.spin(reverse, 70, pct);
    }
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    while(Controller1.ButtonRight.pressing()){  //Expands bot
      ExpansionF.spin(fwd, 50, pct);  //Expansion motors
      ExpansionB.spin(fwd, 50, pct);

      BLMotor.spin(fwd, 20, pct);  //Wheel motors
      BRMotor.spin(fwd, 20, pct);
      FLMotor.spin(reverse, 20, pct);
      FRMotor.spin(reverse, 20, pct);
    }
    ...
    while(Controller1.ButtonRight.pressing()){  //Shrinks bot
      ...
      BLMotor.spin(reverse, 20, pct);  //Wheel motors
      BRMotor.spin(reverse, 20, pct);
      FLMotor.spin(fwd, 20, pct);
      FRMotor.spin(fwd, 20, pct);
    }
