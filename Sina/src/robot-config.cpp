...
motor BLMotor = motor(PORT1, ratio18_1, true);
motor BRMotor = motor(PORT2, ratio18_1, false);
motor FLMotor = motor(PORT3, ratio18_1, true);
motor FRMotor = motor(PORT4, ratio18_1, false);
motor ExpansionF = motor(PORT15, ratio36_1, false);
motor ExpansionB = motor(PORT19, ratio36_1, false);
